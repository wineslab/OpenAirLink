...
//
// Module: noc_shell_upols
//
// Description:
//
//   NoC shell for the upols block. Structurally identical to
//   noc_shell_complex_sparse_fir — a single sc16 input, a single sc16
//   output, ctrlport slave.  Only the NOC_ID differs (0x5F1A0005).
//
// Parameters:
//
...
module noc_shell_upols #(
  ...
  backend_iface #(
    .NOC_ID        (32'h5F1A0005),  // Unique NOC ID for UPOLS FIR
    .NUM_DATA_I    (1),
    .NUM_DATA_O    (1),
  ...
  ) chdr_to_axis_pyld_ctxt_in (
    .axis_chdr_clk         (rfnoc_chdr_clk),
    .axis_chdr_rst         (rfnoc_chdr_rst),
    .axis_data_clk         (axis_data_clk),
    .axis_data_rst         (axis_data_rst),
    .s_axis_chdr_tdata     (s_rfnoc_chdr_tdata),
    .s_axis_chdr_tlast     (s_rfnoc_chdr_tlast),
    .s_axis_chdr_tvalid    (s_rfnoc_chdr_tvalid),
    .s_axis_chdr_tready    (s_rfnoc_chdr_tready),
  ...
  axis_pyld_ctxt_to_chdr #(
    ...
    .MTU                 (MTU),
    .CONTEXT_PREFETCH_EN (1)
  ) axis_pyld_ctxt_to_chdr_out (
    .axis_chdr_clk         (rfnoc_chdr_clk),
    .axis_chdr_rst         (rfnoc_chdr_rst),
    .axis_data_clk         (axis_data_clk),
    .axis_data_rst         (axis_data_rst),
    .m_axis_chdr_tdata     (m_rfnoc_chdr_tdata),
    .m_axis_chdr_tlast     (m_rfnoc_chdr_tlast),
    .m_axis_chdr_tvalid    (m_rfnoc_chdr_tvalid),
    .m_axis_chdr_tready    (m_rfnoc_chdr_tready),
